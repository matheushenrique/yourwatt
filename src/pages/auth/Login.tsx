...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    alert('Integração com Google OAuth será implementada');
  };
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 animate-slide-up">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-sm font-semibold text-blue-800 mb-2">🔑 Credenciais de Teste:</p>
            <p className="text-xs text-blue-700"><strong>Admin:</strong> admin@solar.com / 123456</p>
            <p className="text-xs text-blue-700"><strong>Usuário:</strong> user@solar.com / 123456</p>
          </div>
        ...
        <div className="text-center mt-8 text-sm text-blue-200">
          <p>© 2025 Solar Energy. Todos os direitos reservados.</p>
        </div>
      </div>
